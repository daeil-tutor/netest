...
export default function App() {
  var _a = useState(null),
    hoverRecommendId = _a[0],
    setHoverRecommendId = _a[1];
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx(GnbBar, {}),
      _jsx(Banner, { imageUrl: imgBanner, events: bannerEvents, height: 560 }),
      _jsxs("div", {
        style: {
          maxWidth: "1280px",
          width: "100%",
              ...
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx("div", {
                    ...
                    children: recommendedGames.map(function (game) {
                      return _jsx(
                        "div",
                        {
                          onMouseEnter: function () {
                            return setHoverRecommendId(game.id);
                          },
                          onMouseLeave: function () {
                            return setHoverRecommendId(null);
                          },
                          children: _jsx(RecommendItem, {
                            status:
                              hoverRecommendId === game.id
                                ? "hover"
                                : "default",
          ...
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("div", {
                ...
                children: gameFilters.map(function (filter) {
                  return _jsx(
                    GameFilter,
                    {
                      label: filter.name,
              ...
              _jsx("div", {
                ...
                children: gameCards.map(function (card) {
                  return _jsx(
                    "div",
                    {
                      style: {
                      ...
                      onMouseEnter: function () {
                        return setHoverCardId(card.id);
                      },
                      onMouseLeave: function () {
                        return setHoverCardId(null);
                      },
