...
export var WithClick = {
    args: {
        ...
        badgeType: "pick",
        imageUrl: itemThumbnail1,
        onClick: function () { return alert("Recommend item clicked!"); },
    },
};
