...
export var WithClick = {
    args: {
        style: "vertical",
        gameName: "Game Name",
        gameCategory: "Action RPG",
        imageUrl: cardThumbnail1,
        onClick: function () { return alert("Card clicked!"); },
    },
};
